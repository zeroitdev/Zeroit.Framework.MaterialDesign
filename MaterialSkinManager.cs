...
// ***********************************************************************
// <copyright file="MaterialSkinManager.cs" company="Zeroit Dev Technologies">
...
using Zeroit.Framework.MaterialDesign.Properties;

namespace Zeroit.Framework.MaterialDesign
{
    /// <summary>
    /// Class ZeroitMaterialSkinManager.
    /// </summary>
    public class ZeroitMaterialSkinManager
    {
        //Singleton instance
        /// <summary>
        /// The instance
        /// </summary>
        private static ZeroitMaterialSkinManager _instance;

        //Forms to control
        /// <summary>
        /// The forms to manage
        /// </summary>
        private readonly List<ZeroitMaterialForm> _formsToManage = new List<ZeroitMaterialForm>();
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="ZeroitMaterialSkinManager"/> class from being created.
        /// </summary>
        private ZeroitMaterialSkinManager()
        {
        ...
        public static ZeroitMaterialSkinManager Instance => _instance ?? (_instance = new ZeroitMaterialSkinManager());

        /// <summary>
        /// Adds the form to manage.
        /// </summary>
        /// <param name="materialForm">The material form.</param>
        public void AddFormToManage(ZeroitMaterialForm materialForm)
        {
        ...
        /// </summary>
        /// <param name="materialForm">The material form.</param>
        public void RemoveFormToManage(ZeroitMaterialForm materialForm)
        {
        ...
        private void UpdateControl(Control controlToUpdate, Color newBackColor)
        {
            ...
            var tabControl = controlToUpdate as ZeroitMaterialTabControl;
            if (tabControl != null)
            {
            ...
            if (controlToUpdate is ZeroitMaterialDivider)
            {
                controlToUpdate.BackColor = GetDividersColor();
            }

            if (controlToUpdate is ZeroitMaterialListView)
            {
